...
void KSession::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 29: { Session* _r = _t->createSession((*reinterpret_cast< QString(*)>(_a[1])));
            if (_a[0]) *reinterpret_cast< Session**>(_a[0]) = _r; }  break;
        default: ;
        }
        ...
        {
            typedef void (KSession::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&KSession::started)) {
                *result = 0;
                return;
            }
        }
        {
            typedef void (KSession::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&KSession::finished)) {
                *result = 1;
                return;
            }
        }
        {
            typedef void (KSession::*_t)(bool );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&KSession::copyAvailable)) {
                *result = 2;
                return;
            }
        }
        {
            typedef void (KSession::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&KSession::termGetFocus)) {
                *result = 3;
                return;
            }
        }
        {
            typedef void (KSession::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&KSession::termLostFocus)) {
                *result = 4;
                return;
            }
        }
        {
            typedef void (KSession::*_t)(QKeyEvent * );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&KSession::termKeyPressed)) {
                *result = 5;
                return;
            }
        }
        {
            typedef void (KSession::*_t)(QString );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&KSession::changedKeyBindings)) {
                *result = 6;
                return;
            }
        }
        {
            typedef void (KSession::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&KSession::titleChanged)) {
                *result = 7;
                return;
            }
        }
        {
            typedef void (KSession::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&KSession::historySizeChanged)) {
                *result = 8;
                return;
            }
        }
        {
            typedef void (KSession::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&KSession::initialWorkingDirectoryChanged)) {
                *result = 9;
                return;
            }
        }
        {
            typedef void (KSession::*_t)(int , int , int , int );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&KSession::matchFound)) {
                *result = 10;
                return;
            }
        }
        {
            typedef void (KSession::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&KSession::noMatchFound)) {
                *result = 11;
                return;
            }
        }
...
const QMetaObject KSession::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_KSession.data,
      qt_meta_data_KSession,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *KSession::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_KSession.stringdata0))
        return static_cast<void*>(const_cast< KSession*>(this));
